...
- current_phase: Phase 2 partial map smoke passed
...
| Mapping and Viewpoint | running | Partial map smoke passed; candidate gain next | BEV grid has known_free, occupied, unknown, frontier. |
