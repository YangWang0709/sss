...
- current_phase: Phase 0 audit complete; fallback scene-load smoke passed
...
| IsaacSim Scene and Sensor | running | Fallback scene load validated; sensor smoke next | Primary USD still crashes, fallback scene smoke status: passed. |
